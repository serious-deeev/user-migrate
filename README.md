### Текущий сервис
* user-post-storage-db-service – микросервис выполнения миграций БД для сервисов user-service, post-service и order-service, которые работают в рамках одной схемы
